...
exports.logger = winston_1.default.createLogger({
    ...
    transports: [
        ...
        new winston_1.default.transports.File({
            filename: path_1.default.join(logsDir, 'akshays-framework-worker.log'),
            level: 'info'
        }),
        new winston_1.default.transports.File({
            filename: path_1.default.join(logsDir, 'akshays-framework-worker-error.log'),
            level: 'error'
        })
    ],
    exceptionHandlers: [
        new winston_1.default.transports.File({
            filename: path_1.default.join(logsDir, 'akshays-framework-worker-exception.log')
        })
    ],
    rejectionHandlers: [
        new winston_1.default.transports.File({
            filename: path_1.default.join(logsDir, 'akshays-framework-worker-rejection.log')
        })
    ]
});
exports.stream = {
